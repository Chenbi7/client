...
function HomePageParent({ navigation }) {
    ...
    React.useEffect(() => {
      ...
      setCurrentBabySitterDisplay([
          { name: "מאור בבר", rate:4, location: "ישראל", phoneNumber: "054-9542812", description:"היה ממש נחמד ותיקשר יפה עם הילדים" },
          { name: "חן ביטון", rate:3, location: "ישראל", phoneNumber: "054-9542812", description:"שמחתי להשאיר את הילדים עם אדם כה אחראי" },
      ]);
    }, []);
            ...
            <View>
                ...
                <View style={[styles.tableHeaders, {backgroundColor: theme.colors.backgroundGreen}]}>
                    <View style={styles.tableRow}>
                        <Paragraph style={[globalStyles.fontFamilyApp, styles.descriptionColumn]}>ביקורת</Paragraph>
                        <Paragraph style={[globalStyles.fontFamilyApp, styles.titleColumn]}>שם</Paragraph>
                        <Paragraph style={styles.iconColumn}><Paragraph>דירוג</Paragraph></Paragraph>
                            ...
                            <View>
                                <View style={[styles.tableRow, {height: 90, width: '100%'}]}>
                                    ...
                                    <View style={styles.descriptionColumn}>
                                        <Paragraph style={globalStyles.rtlDirection}>{user?.description}</Paragraph>
                                    </View>
