...
function VerifyMail({ navigation }) {
  ...
  const [visibleCreateUserLoading, setVisibleCreateUserLoading] =
    React.useState(false);
  const [isUnauthorizedUserModal, setUnauthorizedUserModal] =
    React.useState(false);
  ...
  function resendMail() {
    ...
    HttpService.sendCode({ email: route.params.email })
      .then((user) => {
          ...
          <ScrollView style={{ height: "100%" }}>
            ...
            >
              <View>
                ...
                />
                <Loading
                  visibleLoading={visibleResendLoading}
                  setVisibleLoading={setVisibleResendLoading}
                  message={"שולח קוד חדש"}
                />
                <Loading
                  visibleLoading={visibleCreateUserLoading}
